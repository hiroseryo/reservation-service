    ...
    public function run(): void
    {
        ...
        $shops = [
            ...
            [
                ...
                'area' => '大阪府',
                'genre' => '居酒屋',
                'description' => '毎年チャンピオン牛を買い買仙台市長から表彰されるほどの上質な仕入れをする精肉店オーナーの本当に美味しい国産牛を食べてもらいたいという思いから誕生したお店です。',
                'image_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg',
            ],
            [
                'name' => '三子',
        ...
        foreach ($shops as $shop) {
            $area = Area::firstOrCreate(['name' => $shop['area']]);

            $genre = Genre::firstOrCreate(['name' => $shop['genre']]);
            ...
            $user = User::firstOrCreate(
                ...
                [
                    'password' => Hash::make('laravel_pass'),
                ]
            );
